 ...
 */
export declare function between(number: number, minOrMax: number, maxOrMin: number, exclusive?: boolean): boolean;
//# sourceMappingURL=../../../../../../../../../splide/src/js/utils/math/between/between.d.ts.map